...
public class reporteArticulo {
    ...
    public void getMovimientoComprobantesiva(String ruta, Date fechaini, Date fechafinal) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        if (ruta != null) {
    ...
    public void getMovimientoComprobantesislr(String ruta, Date fechaini, Date fechafinal) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        if (ruta != null) {
    ...
    public void getMovimientoFacturas(String ruta, int status, Date fechaini, Date fechafinal) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        if (ruta != null) {
